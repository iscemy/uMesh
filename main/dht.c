 ...
 *
 */
//mponents/esp8266/include/rom/ets_sys.h:
...
#include <rom/ets_sys.h> // sdk_os_delay_us
...
/*quick and dirty port to official rtos sdk*/
void gpio_set_od(uint8_t pin){
...
void gpio_write(uint8_t pin, bool status){
